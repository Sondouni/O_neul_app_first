package com.example.o_neul_first.common;
...
public class CurLocation implements LocationListener {
    ...
    public CurLocation(Context context) { this.mContext = context; getLocation(); }
    ...
    public void stopUsingGPS() {
        if(locationManager != null) {
            locationManager.removeUpdates(CurLocation.this);
        }
    }
